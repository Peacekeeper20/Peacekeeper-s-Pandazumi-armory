...
SWEP.PrintName = "Black Ops Battle rifle (50 round)"
...
SWEP.Delay = 0.075 -- Delay between shots in seconds, use X / 60 for rounds per minute
...
SWEP.Recoil = {
	Kick = Angle(0.35, 0.25), -- View kick

	-- Viewmodel kick
	HipOffset = Vector(-0.2, 0, -0.3),
	HipPitch = 1,

	AimOffset = Vector(-0.2, 0, -0.1),
	AimPitch = 1.2,
