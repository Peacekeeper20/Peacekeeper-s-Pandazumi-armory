...
SWEP.Delay = 0.16 -- Delay between shots in seconds, use X / 60 for rounds per minute
...
SWEP.Range = 2000 -- Range in source units at which every shot lands in a SWEP.Accuracy radius circle
...
SWEP.Recoil = {
	Kick = Angle(0.7, 0.9), -- View kick

	-- Viewmodel kick
	HipOffset = Vector(-6, 1, 1),
	HipPitch = 2,

	AimOffset = Vector(-3, 0, 0.5),
	AimPitch = 1.5,

	Time = 0.6 -- Time it takes for the viewmodel to reset
}
...
SWEP.Sounds = {
	Fire = Sound("weapons/pandazumi/p30_firing.wav"),
